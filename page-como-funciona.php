...
<main>
    <section
        ...
        <div class="container">
            <div class="max-w-4xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">Mais do que cursos.<br><span class="text-primary">Um
                        ecossistema completo de transformação.</span></h1>
                <p class="text-lg md:text-xl">O VdeVAREJO é uma plataforma integrada que combina aprendizado online,
                    eventos presenciais, comunidade exclusiva e mentorias para garantir que a transformação do seu
                    varejo aconteça de verdade.</p>
            </div>
        </div>
    </section>
    <section class="py-16 md:py-24 bg-background">
        <div class="container">
            <h2 class="text-3xl md:text-4xl font-bold text-center mb-12">Os 3 Componentes do Ecossistema VdeVAREJO</h2>
                ...
                <div data-slot="card"
                    ...
                    <div data-slot="card-content" class="px-6 pt-6">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold mb-2">1. Eventos Presenciais</h3>
                                <p class="text-sm text-muted-foreground mb-4">Saia do operacional e entre no
                                    estratégico.</p>
                            </div>
                        </div>
                        <ul class="space-y-2 ml-16">
                            <li class="flex items-start gap-2"><span class="text-primary mt-1">•</span><span
                                    class="text-sm">Imersões e workshops regionais</span></li>
                            <li class="flex items-start gap-2"><span class="text-primary mt-1">•</span><span
                                    class="text-sm">Networking de alto nível com outros varejistas</span></li>
                            <li class="flex items-start gap-2"><span class="text-primary mt-1">•</span><span
                                    class="text-sm">Aprendizado experiencial (hands-on)</span></li>
                            <li class="flex items-start gap-2"><span class="text-primary mt-1">•</span><span
                                    class="text-sm">Acesso a especialistas e líderes do mercado</span></li>
                        </ul>
                    </div>
                </div>
                <div data-slot="card"
                    ...
                    <div data-slot="card-content" class="px-6 pt-6">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold mb-2">2. Comunidade Exclusiva</h3>
                                <p class="text-sm text-muted-foreground mb-4">Você não está mais sozinho.</p>
                            </div>
                        </div>
                        <ul class="space-y-2 ml-16">
                            <li class="flex items-start gap-2"><span class="text-primary mt-1">•</span><span
                                    class="text-sm">Fórum privado para troca de experiências</span></li>
                            <li class="flex items-start gap-2"><span class="text-primary mt-1">•</span><span
                                    class="text-sm">Sessões de peer mentoring</span></li>
                            <li class="flex items-start gap-2"><span class="text-primary mt-1">•</span><span
                                    class="text-sm">Grupos de estudo por região/setor</span></li>
                            <li class="flex items-start gap-2"><span class="text-primary mt-1">•</span><span
                                    class="text-sm">Suporte contínuo da equipe VdeVAREJO</span></li>
                        </ul>
                    </div>
                </div>
                <div data-slot="card"
                    ...
                    <div data-slot="card-content" class="px-6 pt-6">
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold mb-2">3. Mentorias e Acompanhamento</h3>
                                <p class="text-sm text-muted-foreground mb-4">Garantia de que a transformação vai
                                    acontecer.</p>
                            </div>
                        </div>
                        <ul class="space-y-2 ml-16">
                            <li class="flex items-start gap-2"><span class="text-primary mt-1">•</span><span
                                    class="text-sm">Sessões de hotseat em grupo</span></li>
                            <li class="flex items-start gap-2"><span class="text-primary mt-1">•</span><span
                                    class="text-sm">Acompanhamento de implementação</span></li>
                            <li class="flex items-start gap-2"><span class="text-primary mt-1">•</span><span
                                    class="text-sm">Suporte via WhatsApp/E-mail</span></li>
                            <li class="flex items-start gap-2"><span class="text-primary mt-1">•</span><span
                                    class="text-sm">Mentorias individuais (upgrade disponível 2º sem/2026)</span></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 md:py-24 bg-secondary text-secondary-foreground">
        <div class="container">
            <h2 class="text-3xl md:text-4xl font-bold text-center mb-12">Sua Jornada de Transformação</h2>
            <div class="max-w-4xl mx-auto space-y-8">
                <div class="flex gap-6">
                    <div class="flex flex-col items-center">
                        <div
                            class="w-12 h-12 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold text-lg">
                            1</div>
                        <div class="w-1 flex-1 bg-primary/30 mt-2"></div>
                    </div>
                    <div data-slot="card"
    ...
    <section class="py-16 md:py-24 bg-background">
        <div class="container text-center">
            <h2 class="text-3xl md:text-4xl font-bold mb-6">Pronto para começar sua jornada de transformação?</h2>
