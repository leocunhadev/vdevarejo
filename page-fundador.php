        ...
        <div class="container">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex items-center justify-center gap-2 text-lg"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <p class="font-semibold">Oferta válida até 30 de Novembro ou até esgotar as vagas.</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div data-slot="card"
                        ...
                        <div data-slot="card-content" class="px-6">
                            <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <div>
                                    <h3 class="font-bold mb-1">Eventos Presenciais</h3>
                                    <p class="text-sm text-muted-foreground">Pelo menos 2 eventos regionais por ano</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div data-slot="card-content" class="px-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <div>
                                    <p class="font-bold">20% de desconto vitalício</p>
                            ...
                            <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <div>
                                    <p class="font-bold">Selo de Pioneiro</p>
                            ...
                            <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <div>
                                    <p class="font-bold">Acesso antecipado</p>
                            ...
                            <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <div>
                                    <p class="font-bold">Prioridade em eventos</p>
                            ...
                            <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <div>
                                    <p class="font-bold">2 sessões extras de mentoria</p>
                            ...
                            <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <div>
                                    <p class="font-bold">Kit de ferramentas físico</p>
                                    <p class="text-sm text-muted-foreground">Planilhas, guias e brindes</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div data-slot="card"
                    ...
                    <div data-slot="card-content" class="px-6">
                        <div class="text-center mb-6"><svg xmlns="http://www.w3.org/2000/svg" width="64" height="64"
                            ...
                            <h2 class="text-3xl font-bold mb-4">Garantia Incondicional de 30 Dias</h2>
                        </div>
                        <p class="text-lg text-center text-muted-foreground mb-6">Nós assumimos todo o risco. Você tem
                            30 dias para testar tudo: plataforma, conteúdo, comunidade, eventos. Se por qualquer motivo
                            você não ficar satisfeito, basta enviar um e-mail e devolvemos 100% do seu investimento.</p>
                        <p class="text-center font-bold">Sem perguntas, sem burocracia.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div data-slot="card"
                    ...
                    <div data-slot="card-content" class="px-6">
                        <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <div>
                                <h3 class="font-bold mb-2">Isso funciona para o meu tipo de varejo?</h3>
                                <p class="text-sm text-muted-foreground">Sim. A metodologia dos 7 Vs foi desenhada para
                                    qualquer tipo de varejo, mas é especialmente poderosa para varejistas do setor
                                    alimentar, que é nosso foco inicial.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div data-slot="card"
                    ...
                    <div data-slot="card-content" class="px-6">
                        <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <div>
                                <h3 class="font-bold mb-2">Eu não tenho tempo para fazer cursos online.</h3>
                                <p class="text-sm text-muted-foreground">Nós entendemos. Por isso, nosso conteúdo é
                                    direto ao ponto (vídeos de 10-15 min) e as ferramentas são prontas para usar. Você
                                    aplica no dia seguinte.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div data-slot="card"
                    ...
                    <div data-slot="card-content" class="px-6">
                        <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <div>
                                <h3 class="font-bold mb-2">Já fiz outros cursos e não funcionou.</h3>
                                <p class="text-sm text-muted-foreground">A diferença do VdeVAREJO é o acompanhamento.
                                    Você não está sozinho. Temos comunidade, mentoria e eventos para garantir que você
                                    implemente.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div data-slot="card"
                    ...
                    <div data-slot="card-content" class="px-6">
                        <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <div>
                                <h3 class="font-bold mb-2">Qual o investimento?</h3>
                                <p class="text-sm text-muted-foreground">Entre em contato conosco para conhecer as
                                    condições especiais para os 500 primeiros. O desconto de 20% vitalício em todos os
                                    programas é exclusivo para quem entrar agora.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div data-slot="card"
                    ...
                    <div data-slot="card-content" class="px-6">
                        <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <div>
                                <h3 class="font-bold mb-2">Como funciona a garantia?</h3>
                                <p class="text-sm text-muted-foreground">Simples. Você tem 30 dias para testar tudo. Se
                                    não gostar, devolvemos 100% do valor. Sem perguntas, sem burocracia.</p>
                            </div>
                        </div>
                    </div>
                </div>
